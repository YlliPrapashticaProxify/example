...
async function readResources(args) {
  ...
  for (const language of args.config.languages) {
    ...
    const flatJson = (0, import_flat.default)(
...
function serializeResource(resource) {
  ...
  console.log(2, flatObject);
  console.log(3, import_flat.default.unflatten(flatObject));
  return JSON.stringify(import_flat.default.unflatten(flatObject), null, 2);
}
